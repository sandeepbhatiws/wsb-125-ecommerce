"use client";
import { cartDelete, decrement, increment } from '@/app/Redux ToolKit/Slices/cart';
        ...
        
        {
          cartItems.map((v,i) => {
            ...
            <div class="ml-3 flex w-full flex-col justify-center">
              ...
              <p class="py-3 text-xl font-bold text-violet-900">{v.price}</p>
          ...
          <table class="table-fixed">
...

            {
              cartItems.map((v,i) => {
                ...
                <td class="align-middle">
                  <div class="flex items-center justify-center">
                    <button onClick={() => dispatch(decrement(v.id))}
                      class="flex h-8 w-8 cursor-pointer items-center justify-center border duration-100 hover:bg-neutral-100 focus:ring-2 focus:ring-gray-500 active:ring-2 active:ring-gray-500"
                    >
                      &minus;
                    </button>
                    ...
                    <button onClick={() => dispatch(increment(v.id))}
                      class="flex h-8 w-8 cursor-pointer items-center justify-center border duration-100 hover:bg-neutral-100 focus:ring-2 focus:ring-gray-500 active:ring-2 active:ring-gray-500"
                    >
                      &#43;
                    </button>
                ...
                <td class="mx-auto text-center">&#36;{v.qty * v.price}</td>
                <td class="align-middle">
                  <svg onClick={() => dispatch(cartDelete(v.id))}
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                    class="m-0 h-5 w-5 cursor-pointer"
          ...
          <div class="">
            <div class="border py-5 px-4 shadow-md">
              ...
              <div class="flex justify-between border-b py-5">
                <p>Subtotal</p>
                <p>${cartTotal.toLocaleString(2)}</p>
              </div>
